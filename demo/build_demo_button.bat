...
%CXX% "%DEMO_SRC_DIR%\demo_button.cpp" "%LIB_SRC_DIR%\button.cpp" "%LIB_SRC_DIR%\combobox.cpp" "%LIB_SRC_DIR%\themed_window_host.cpp" %CXXFLAGS% -o "%BUILD_DIR%\darkui_button_demo.exe" %LDFLAGS%
if errorlevel 1 goto error

echo Build succeeded: "%BUILD_DIR%\darkui_button_demo.exe"
goto end
