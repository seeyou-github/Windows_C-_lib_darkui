...
%CXX% "%DEMO_SRC_DIR%\demo_toolbar.cpp" "%LIB_SRC_DIR%\toolbar.cpp" "%LIB_SRC_DIR%\button.cpp" "%LIB_SRC_DIR%\progress.cpp" "%LIB_SRC_DIR%\scrollbar.cpp" "%LIB_SRC_DIR%\slider.cpp" "%LIB_SRC_DIR%\combobox.cpp" "%LIB_SRC_DIR%\tab.cpp" "%LIB_SRC_DIR%\themed_window_host.cpp" %CXXFLAGS% -o "%BUILD_DIR%\darkui_toolbar_demo.exe" %LDFLAGS%
