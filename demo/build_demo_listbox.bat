...
%CXX% "%DEMO_SRC_DIR%\demo_listbox.cpp" "%LIB_SRC_DIR%\listbox.cpp" "%LIB_SRC_DIR%\combobox.cpp" "%LIB_SRC_DIR%\themed_window_host.cpp" %CXXFLAGS% -o "%BUILD_DIR%\darkui_listbox_demo.exe" %LDFLAGS%
