...
%CXX% "%DEMO_SRC_DIR%\demo_scrollbar.cpp" "%LIB_SRC_DIR%\scrollbar.cpp" "%LIB_SRC_DIR%\combobox.cpp" "%LIB_SRC_DIR%\themed_window_host.cpp" %CXXFLAGS% -o "%BUILD_DIR%\darkui_scrollbar_demo.exe" %LDFLAGS%
if errorlevel 1 goto error

echo Build succeeded: "%BUILD_DIR%\darkui_scrollbar_demo.exe"
goto end
